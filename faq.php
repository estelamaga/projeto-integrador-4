...
<div class="faq container">
  <h1> Perguntas Frequentes</h1>
    ...
    <div class="subtitulo">
      ...
      <div class="pergunta">
        <h3 class="btn btn-success" data-toggle="collapse" data-target="#lmn">VII) Como faço para trocar um produto?</h3>
        <h4 id="lmn" class="collapse">Toda solicitação de troca, devolução, arrependimento e avaria do produto deverá ser comunicado por email</h4>
