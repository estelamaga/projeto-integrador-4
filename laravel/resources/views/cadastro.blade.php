            ...
            <form  action="/cadastro/pessoa-fisica" method="post" enctype="multipart/form-data" class="row"><!-- Inicio Form -->
              ...
              <div class="col-lg-12 col-md-12 col-sm-12"><!-- Inicio Div -->
                <div class="col-lg-5 col-md-6 col-sm-6">
                  ...
                  <input type="text" class="form-control" id="nome" maxlength="40"  name="nome" placeholder="Insira seu nome"><br>
                </div>
              </div><!-- Fim Div -->
              ...
              <div class="col-lg-12 col-md-12 col-sm-12"><!-- Inicio Div -->
                <div class="col-lg-5 col-md-6 col-sm-6">
                  ...
                  <input type="password" class="form-control" id="senha" maxlength=15  name="senha" placeholder="Informe sua senha"><br>
                </div>
              </div><!-- Fim Div -->
