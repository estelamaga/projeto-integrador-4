			...
			<div class="container-fliud">
				<div class="wrapper row">
					...
					<div class="details col-md-6">
						...
						<p class="product-description">Camiseta feita com algodão 100% sustentável, tecido de melhor qualidade.<br> A maior torcida desse brasil vai adorar este produto</p>
						<h4 class="price">Preço atual: <span>R$200,00</span></h4>
